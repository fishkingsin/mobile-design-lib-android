 ...
 * Use the [WWThemeFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WWThemeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<TextView>(R.id.themeName).text = "WW"
        return view
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment WWThemeFragment.
         */
