 ...
 * Use the [OHThemeFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OHThemeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<TextView>(R.id.themeName).text = "OH"
        return view
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment OHThemeFragment.
         */
